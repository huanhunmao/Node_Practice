// This is more easily done by using the .read() method of the socket,
//  since we can control when to stop pulling data from the stream. Here's some code to do this:
